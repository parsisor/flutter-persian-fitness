...
final List<WorkoutBase> wdataset = [
  ...
  WorkoutBase(
    ...
    name: "اسکات",
    wGif:
        'assets/workout/zerang pack/man-doing-bodyweight-good-morning-exercise-8294642-6634976.gif',
    wstime: 60,
    avcalorie: 200,
    wlevel: "آسان/easy",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "لانژ",
    wGif:
        'assets/workout/zerang pack/man-doing-barbell-split-squat-exercise-for-legs-11095301-8971922.gif',
    wstime: 90,
    avcalorie: 150,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "بارفیکس",
    wGif:
        'assets/workout/zerang pack/man-doing-wide-pull-up-exercise-8754594-7066429.gif',
    wstime: 30,
    avcalorie: 100,
    wlevel: "سخت/hard",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "دیپ",
    wGif:
        'assets/workout/zerang pack/man-doing-bench-dip-exercise-8754596-7066431.gif',
    wstime: 30,
    avcalorie: 80,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "کرانچ",
    wGif:
        'assets/workout/zerang pack/man-doing-bicycle-crunch-exercise-8574453-6770295.gif',
    wstime: 60,
    avcalorie: 50,
    wlevel: "آسان/easy",
  ...
  WorkoutBase(
    ...
    name: "برپی",
    wGif:
        'assets/workout/zerang pack/man-doing-lunge-jump-alternating-exercise-8294627-6634961.gif',
    wstime: 30,
    avcalorie: 150,
    wlevel: "سخت/hard",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "جامپینگ جک",
    wGif:
        'assets/workout/zerang pack/man-doing-side-split-squats-exercise-8294641-6634975.gif',
    wstime: 60,
    avcalorie: 100,
    wlevel: "آسان/easy",
  ...
  WorkoutBase(
    ...
    name: "پلانک",
    wGif:
        'assets/workout/zerang pack/man-doing-body-saw-exercise-9316868-7613220.gif',
    wstime: 120,
    avcalorie: 250,
    wlevel: "متوسط/Medium",
  ...
  WorkoutBase(
    ...
    name: "سنگ کشی",
    wGif:
        'assets/workout/zerang pack/man-doing-overhead-forward-lunges-alternating-exercise-8754606-7066440.gif',
    wstime: 60,
    avcalorie: 150,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "فلکه",
    wGif:
        'assets/workout/zerang pack/man-doing-plank-jumping-lunges-exercise-8613999-6830364.gif',
    wstime: 90,
    avcalorie: 200,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: " ریه پرش",
    wGif:
        'assets/workout/zerang pack/man-doing-jumping-lunges-exercise-9599460-7772712.gif',
    wstime: 60,
    avcalorie: 120,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/aerobic bodyweight",
  ...
  WorkoutBase(
    ...
    name: "رالی",
    wGif:
        'assets/workout/zerang pack/man-doing-curtsy-lunge-exercise-8574462-6770304.gif',
    wstime: 45,
    avcalorie: 100,
    wlevel: "آسان/easy",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    wsection: ["pa"],
    name: "اسکات هوا",
    wGif: 'assets/workout/zerang pack/man-doing-air-squat-exercise.gif',
    wstime: 60,
    avcalorie: 150,
    wlevel: "آسان/easy",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    wGif:
        'assets/workout/zerang pack/man-doing-alternating-leg-raises-exercise-9599456-7772708.gif',
    wstime: 50,
    avcalorie: 100,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "شنا آرچر",
    wGif:
        'assets/workout/zerang pack/man-doing-archer-push-up-exercise-8574472-6770293.gif',
    wstime: 80,
    avcalorie: 250,
    wlevel: "سخت/Hard",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    wGif:
        'assets/workout/zerang pack/man-doing-alternating-renegade-row-exercise-for-back-10850668-8798371.gif',
    wstime: 70,
    avcalorie: 180,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    wGif:
        'assets/workout/zerang pack/man-doing-assisted-pistol-squat-exercise-8574452-6770294.gif',
    wstime: 90,
    avcalorie: 220,
    wlevel: "سخت/Hard",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  wsection: ["pa"],
  name: "کشش Y پشت",
  wGif: 'assets/workout/zerang pack/man-doing-y-back-extension-exercise-8754595-7066430.gif',
  wstime: 70,
  avcalorie: 130,
  wlevel: "متوسط/Medium",
  wType: "تمرینات بدنی/compound bodyweight",
...
WorkoutBase(
  ...
  wsection: ["pa"],
  name: "وایپرها",
  wGif: 'assets/workout/zerang pack/man-doing-wipers-exercise-8613983-6830349.gif',
  wstime: 60,
  avcalorie: 110,
  wlevel: "سخت/Hard",
  wType: "تمرینات بدنی/compound bodyweight",
...
WorkoutBase(
  ...
  wsection: ["sine", "bazo"],
  name: "شنا پهن",
  wGif: 'assets/workout/zerang pack/man-doing-wide-push-up-exercise-9316866-7613219.gif',
  wstime: 80,
  avcalorie: 160,
  wlevel: "متوسط/Medium",
  wType: "تمرینات بدنی/compound bodyweight",
...
WorkoutBase(
  ...
  wsection: ["pa", "bazo"],
  name: "پول آپ پهن",
  wGif: 'assets/workout/zerang pack/man-doing-wide-pull-up-exercise-8754594-7066429.gif',
  wstime: 90,
  avcalorie: 190,
  wlevel: "سخت/Hard",
  wType: "تمرینات بدنی/compound bodyweight",
...
WorkoutBase(
  ...
  wsection: ["sine"],
  name: "دیپس وزنه دار",
  wGif: 'assets/workout/zerang pack/man-doing-weighted-dips-exercise-for-chest-11218576-8971867.gif',
  wstime: 70,
  avcalorie: 180,
  wlevel: "سخت/Hard",
  wType: "تمرینات بدنی/compound bodyweight",
