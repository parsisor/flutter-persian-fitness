...
final List<WorkoutBase> wdataset = [
  WorkoutBase(
    ...
    wsection: ["sine", "bazo"],
    name: "شنا سوئدی",
    wGif: 'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fpush_up.gif?alt=media&token=012e11c6-5cfa-4f76-ae6e-322f2ed14fef',
    wstime: 120,
    avcalorie: 300,
    wlevel: "متوسط/Medium",
  ...
  WorkoutBase(
    ...
    name: "اسکات",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-bodyweight-good-morning-exercise-8294642-6634976.gif?alt=media&token=05178000-0ad9-4684-ade2-7a38baaebd50',
    wstime: 60,
    avcalorie: 200,
    wlevel: "آسان/easy",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "لانژ",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-barbell-split-squat-exercise-for-legs-11095301-8971922.gif?alt=media&token=1b04ac4b-9c13-4fac-b84d-915478bfd0ef',
    wstime: 90,
    avcalorie: 150,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "بارفیکس",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-wide-pull-up-exercise-8754594-7066429.gif?alt=media&token=0308f32b-869d-42e0-8b77-e90017970612',
    wstime: 30,
    avcalorie: 100,
    wlevel: "سخت/hard",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "دیپ",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-bench-dip-exercise-8754596-7066431.gif?alt=media&token=d1b9dd18-1e3b-4be3-800c-be3bce643692',
    wstime: 30,
    avcalorie: 80,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "کرانچ",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-bicycle-crunch-exercise-8574453-6770295.gif?alt=media&token=900983a6-ecca-42c7-b3de-064889740ff4',
    wstime: 60,
    avcalorie: 50,
    wlevel: "آسان/easy",
  ...
  WorkoutBase(
    ...
    name: "برپی",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-lunge-jump-alternating-exercise-8294627-6634961.gif?alt=media&token=27ea145b-abd0-464b-b033-54e5045eedad',
    wstime: 30,
    avcalorie: 150,
    wlevel: "سخت/hard",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "جامپینگ جک",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-side-split-squats-exercise-8294641-6634975.gif?alt=media&token=358f5f87-a662-4bfc-85e1-868be7d94a94',
    wstime: 60,
    avcalorie: 100,
    wlevel: "آسان/easy",
  ...
  WorkoutBase(
    ...
    name: "پلانک",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-body-saw-exercise-9316868-7613220.gif?alt=media&token=c6a6f04d-75d4-4604-ab0f-ca44c5b0d691',
    wstime: 120,
    avcalorie: 250,
    wlevel: "متوسط/Medium",
  ...
  WorkoutBase(
    ...
    name: "سنگ کشی",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-overhead-forward-lunges-alternating-exercise-8754606-7066440.gif?alt=media&token=fb447232-4231-47b5-9465-7f4c944b8fed',
    wstime: 60,
    avcalorie: 150,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "فلکه",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-plank-jumping-lunges-exercise-8613999-6830364.gif?alt=media&token=b44c7ba5-0ede-40ef-95ef-4409a1bf9b09',
    wstime: 90,
    avcalorie: 200,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: " ریه پرش",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-jumping-lunges-exercise-9599460-7772712.gif?alt=media&token=9b0ddacf-4d85-452f-827b-fa1a10ddd63b',
    wstime: 60,
    avcalorie: 120,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/aerobic bodyweight",
  ...
  WorkoutBase(
    ...
    name: "رالی",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-curtsy-lunge-exercise-8574462-6770304.gif?alt=media&token=b5b5e4cb-1bd5-4f2f-9cc2-4839b6fe189d',
    wstime: 45,
    avcalorie: 100,
    wlevel: "آسان/easy",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    wsection: ["pa"],
    name: "اسکات هوا",
    wGif: 'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-air-squat-exercise.gif?alt=media&token=c8b28d25-3130-4281-bc8e-160721691960',
    wstime: 60,
    avcalorie: 150,
    wlevel: "آسان/easy",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-air-squat-exercise.gif?alt=media&token=c8b28d25-3130-4281-bc8e-160721691960',
    wstime: 50,
    avcalorie: 100,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    name: "شنا آرچر",
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-archer-push-up-exercise-8574472-6770293.gif?alt=media&token=99b14ea8-9aca-4c7e-894d-d6f14d660859',
    wstime: 80,
    avcalorie: 250,
    wlevel: "سخت/Hard",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  WorkoutBase(
    ...
    wGif:
        'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-alternating-renegade-row-exercise-for-back-10850668-8798371.gif?alt=media&token=4cc5e2dc-2eab-4104-9bd0-2098624015ba',
    wstime: 70,
    avcalorie: 180,
    wlevel: "متوسط/Medium",
    wType: "تمرینات بدنی/compound bodyweight",
  ...
  wsection: ["pa"],
  name: "کشش Y پشت",
  wGif: 'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-y-back-extension-exercise-8754595-7066430.gif?alt=media&token=dcfcc691-75de-48f9-b7be-c270f8051d0e',
  wstime: 70,
  avcalorie: 130,
  wlevel: "متوسط/Medium",
  wType: "تمرینات بدنی/compound bodyweight",
...
WorkoutBase(
  ...
  wsection: ["pa"],
  name: "وایپرها",
  wGif: 'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-wipers-exercise-8613983-6830349.gif?alt=media&token=a9f74719-2701-43a4-9ca8-edfb5f022e99',
  wstime: 60,
  avcalorie: 110,
  wlevel: "سخت/Hard",
  wType: "تمرینات بدنی/compound bodyweight",
...
WorkoutBase(
  ...
  wsection: ["sine", "bazo"],
  name: "شنا پهن",
  wGif: 'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-wide-push-up-exercise-9316866-7613219.gif?alt=media&token=9dec6182-5c7f-4f07-8d41-2aa1b0a69160',
  wstime: 80,
  avcalorie: 160,
  wlevel: "متوسط/Medium",
  wType: "تمرینات بدنی/compound bodyweight",
...
WorkoutBase(
  ...
  wsection: ["pa", "bazo"],
  name: "پول آپ پهن",
  wGif: 'https://firebasestorage.googleapis.com/v0/b/zerang-92999.appspot.com/o/zerang_pack%2Fman-doing-wide-pull-up-exercise-8754594-7066429.gif?alt=media&token=0308f32b-869d-42e0-8b77-e90017970612',
  wstime: 90,
  avcalorie: 190,
  wlevel: "سخت/Hard",
  wType: "تمرینات بدنی/compound bodyweight",
