...
class WorkoutsSection extends StatelessWidget {
          ...
          Padding(
            ...
            child: Container(
              ...
              child: CircleAvatar(
                radius: 20.0,
                backgroundImage:
                    AssetImage("assets/Icons/feelings_icons/1x/Asset 2.png"),
              ),
            ),
          ),
        ],
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          "assets/photos/Fitness_journy.png"), 
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
              ...
              SizedBox(height: 8.0),
              _buildClickableContainer(context, 'تمرینات سینه و شکم',
                  'تمرینات سینه و شکم', 'assets/photos/Sine.jpg', 'sine'),
              SizedBox(height: 8.0),
              _buildClickableContainer(context, 'تمرینات بازو و ساعد',
                  'تمرینات بازو و ساعد', 'assets/photos/Bazo.jpg', 'bazo'),
              SizedBox(height: 8.0),
              _buildClickableContainer(context, 'تمرینات پا و ران', 'تمرینات پا و ران',
                  'assets/photos/Pa.jpg', 'pa'),
              SizedBox(height: 8.0),
              _buildClickableContainer(context, 'کل بدن', 'تمرینات کل بدن',
                  'assets/photos/Badan.jpg', 'badan'),
              SizedBox(height: 20.0),
            ],
          ),
        ),
  ...
  Widget _buildClickableContainer(BuildContext context, String title,
      String description, String imagePath, String id) {
